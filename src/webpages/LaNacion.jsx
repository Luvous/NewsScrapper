...
const LaNacion = () => {
    ...
    useEffect(() => {
        fetch('https://newsscrapper-api.herokuapp.com/lanacion')
            .then(res => res.json())
            .then(json => {
                setItems(json)
    ...
    return (
        <div>
            ...
            <div className="news-container">{
                items.map(i => (
                    <a className="article" href={'https://www.lanacion.com.ar' + i.articleLink} key={i.id}>
